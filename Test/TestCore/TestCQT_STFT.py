...
ref_dir = "../../../Test_Data/Reference_Audios"
# source directory for query audios
query_dir = "../../../Test_Data/Modified_Audios/Pitch_Shifted/102"
...
# reference audios
reference_audios = DirManager.find_mp3_files(src_dir=ref_dir)
# query audios
query_audios = DirManager.find_wav_files(src_dir=query_dir)
# time series audio data of reference audio
reference_audio_data = AudioManager.load_audio(audio_path=reference_audios[0], offset=10.0, duration=3.0)
# time series audio data of query audio
query_audio_data = AudioManager.load_audio(audio_path=query_audios[0], offset=10.0)
...
GraphManager.display_spectrogram_peaks(spectrogram=reference_cqt_spectrogram,
