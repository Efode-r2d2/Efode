...
for i in range(-5, 25, 5):
    with open("../../../../Audio A-Z/Results_1/Robustness/Efode/White_Noise/" + str(i) + "/30_sec.csv", 'r') as csvFile:
        ...
        precision.append(p)
        x_axis.append(i)
row = ["Additive Noise", "Accuracy", "Precision"]
result_path = "../../../../Audio A-Z/Results_1/efode_white_noise.csv"
